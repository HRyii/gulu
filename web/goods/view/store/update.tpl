        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>修改仓库 <small></small></h5>
                </div>
                <div class="ibox-content">
                    <form action="{:url('goods/store/update', ['id' => $store['id']])}" method="post" class="form-horizontal" id="commentForm">
                      <div class="form-group">
                          <label class="col-sm-2 control-label">仓库名称</label>
                        <div class="col-sm-4">
                          <input type="text" placeholder="请输入仓库名称" class="form-control" name="name" value="{$store['name']}" required="" aria-required="true">
                        </div>
                      </div>
