        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{:url('goods/Classify/create')}" method="post" class="form-horizontal" id="commentForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" placeholder="请输入分类名称" class="form-control" name="name" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" placeholder="请输入排序" class="form-control" name="sort" value="0">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="radio i-checks">
                                <label>
                                  <input type="radio" value="0" name="display" checked=""> <i></i> 是
                              </label>
                                <label>
                                  <input type="radio" value="1" name="display"> <i></i> 否
                              </label>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
