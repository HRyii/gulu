            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title" style="padding: 16px;min-height: 60px;">
                        ...
                        <button type="button" class="btn btn-sm btn-primary pull-right yele-js-btn-restore-all forever" disabled style="margin-left:10px;"><i class="fa fa-reply"></i><span class="bold">&nbsp;还原</span></button>
                        {/if}
                        {if condition="$__user->can(['goods_goods_del'])"}
                        <button type="button" class="btn btn-sm btn-danger pull-right yele-js-btn-del-all" disabled><i class="fa fa-trash" ></i><span class="bold">&nbsp;彻底删除</span></button>
                        {/if}
                    </div>
                    <div class="search col-sm-12">
                        <form name="searchform" method="post" class="form-horizontal" style="padding: 18px;">
                            ...
                            <div class="input-group" style="width:20%;padding-left:10px;">
                                <input type="text" class="form-control" name="name" value="{$name}" placeholder="请输入商品关键字"> <span class="input-group-btn"> <button type="submit" class="btn btn-primary">搜索
                                </button> </span>
                            </div>
                        </form>
                    </div>
                    <div class="ibox-content">
                        ...
                        {/if}
                        <table class="table table-striped yele-js-restore-list">
                            <thead>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="margin: 0 auto;width: 160px;">
                                            <form action="{:url('goods/goods/restore', ['id' => $Good['id']])}" method="post" style="float: left;">
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-sm btn-primary yele-js-btn-restore"><i class="fa fa-reply"></i><span class="bold">&nbsp;还原</span></button>
                                                </div>
                                            </form>
                                            <form action="{:url('goods/goods/del', ['id' => $Good['id']])}" method="post" style="float: left;margin-left:10px;">
                                                <div class="form-group">
