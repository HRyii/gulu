        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>添加单位 <small></small></h5>
                </div>
                <div class="ibox-content">
                    <form action="{:url('goods/Unit/create')}" method="post" class="form-horizontal" id="commentForm">
                      <div class="form-group">
                          <label class="col-sm-2 control-label">单位名称</label>
                        <div class="col-sm-4">
                          <input type="text" placeholder="请输入单位名称" class="form-control" name="name" required="" aria-required="true">
                        </div>
                      </div>
